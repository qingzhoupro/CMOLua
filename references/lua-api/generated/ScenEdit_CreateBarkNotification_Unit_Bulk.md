...
> 官方文档来源: [https://commandlua.github.io/assets/Function_ScenEdit_CreateBarkNotification_Unit_Bulk.html](https://commandlua.github.io/assets/Function_ScenEdit_CreateBarkNotification_Unit_Bulk.html)  
> 爬取时间: 2026-05-23 10:37:09  
...
- UnitNameOrID
string
The unit name or GUID. As no side is specified, GUID is more reliable
- text
{
                            } of multiple
string
...
`ScenEdit_CreateBarkNotification_Unit_Bulk ('XUL8NN-0HMBJVGGI5PM0', {'Prepare to be amazed','Really!!!'}, 255, 0, 0 )`
